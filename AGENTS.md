# Agent Operating Instructions for actionpin

This file defines how AI agents and human maintainers should work in `actionpin`.

## Project Context

- Project: `actionpin`
- Repository: `git@github.com:rogerchappel/actionpin.git`
- Primary maintainer: ``
- Default branch: `main`
- Package manager: `npm`

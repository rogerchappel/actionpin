...
Ship a genuinely usable local-first TypeScript CLI for `actionpin` matching `docs/PRD.md`.
...
7. Publish
   - Create public GitHub repo `rogerchappel/actionpin` if absent.
   - Push directly to `main` as Roger/admin.
   - Protect `main` best-effort using `/Users/roger/.openclaw/workspace/scripts/protect-github-main.sh rogerchappel actionpin main`.
